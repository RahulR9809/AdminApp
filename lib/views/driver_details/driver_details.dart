...
//         child: Scaffold(
//           appBar: CustomAppBar(
//             title: 'Driver Details',titleStyle: TextStyle(color: AppColors.white),
//             onLeadingPressed: () {
//               context.read<DriverBloc>().add(FetchDrivers());
...
//                               context, driverId: driverDetails['_id'], isBlocked: true));
//                           if (driverDetails['_id'] == null) {
//   ScaffoldMessenger.of(context).showSnackBar(
...
//                           context.read<DriverBloc>().add(BlockUnBlocDriver(
//                               context, driverId: driverDetails['_id'], isBlocked: false));
//                         },
//                             content:
...
class DriverDetailsPage extends StatelessWidget {
  ...
  final Map<String, dynamic>? vehicleDetails;
  const DriverDetailsPage({
    super.key, required this.driverDetails, this.vehicleDetails,
  });
